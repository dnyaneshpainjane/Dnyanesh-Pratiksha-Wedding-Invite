  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-40 -right-24 h-64 w-64 rounded-full bg-[#e6d7be]/30 blur-3xl animate-float-delayed" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
                ...
                <div className="relative h-full rounded-[calc(1.5rem-1px)] bg-white/58 p-5 md:p-6 backdrop-blur-xl">
                  ...
                  <div className="flex items-center gap-3 mb-5">
                    <div className="relative">
                      <div className="absolute inset-0 rounded-full bg-[#b76e79]/20 blur-lg transition-all duration-500 group-hover:scale-125" />
                      <div className="relative w-11 h-11 rounded-full bg-white/75 border border-white shadow-md flex items-center justify-center transition-all duration-500 group-hover:rotate-6 group-hover:scale-105">
                  ...
                  <div className="space-y-2.5 mb-5">
                    ...
                    <div className="flex items-start gap-2.5 rounded-2xl bg-white/55 border border-white/70 px-3.5 py-2.5 shadow-sm backdrop-blur-sm">
                      <span className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#b76e79]/10 text-[#b76e79]">
                        <MapPin className="w-3.5 h-3.5" />
                      </span>
                      <div>
                        <p className="text-[#3f3434] font-sans text-sm">
                          {event.location}
                        </p>
                        <p className="text-[#4a4a4a]/55 text-xs font-sans font-light mt-0.5">
                          {event.address}
                        </p>
                      </div>
                    </div>
                  ...
                  <p className="text-[#4a4a4a]/70 font-sans font-light leading-6 text-sm text-pretty">
                    {event.description}
                  </p>
        ...
        >
          <div className="inline-flex flex-col sm:flex-row items-center gap-2.5 px-5 py-3 rounded-full border border-[#b76e79]/15 bg-white/60 shadow-md shadow-[#b76e79]/10 backdrop-blur-md">
...
function InfoRow({
  ...
  return (
    <div className="flex items-center gap-2.5 rounded-2xl bg-white/55 border border-white/70 px-3.5 py-2.5 shadow-sm backdrop-blur-sm transition-all duration-300 hover:bg-white/80 hover:translate-x-1">
      <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#b76e79]/10 text-[#b76e79]">
        {icon}
      </span>
      <span className="text-[#3f3434] font-sans text-sm">{label}</span>
    </div>
  )
}
