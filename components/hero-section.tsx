  ...
  return (
    <section id="hero" className="relative py-12 md:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#B76E79]/8 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#E6D7BE]/8 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center space-y-8 md:space-y-10 lg:space-y-12">
          ...
          <div className="space-y-4 md:space-y-6 animate-slide-up">
            <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl font-light text-primary tracking-wider drop-shadow-sm">
              Dnyanesh & Pratiksha
            </h1>
            <div className="space-y-2">
              <p className="text-lg md:text-2xl text-[#B76E79] font-light tracking-widest uppercase text-center">
                Our Love Story
              </p>
              <p className="text-lg md:text-xl text-primary/70 font-light italic">
          ...
          <div className="flex justify-center items-center gap-4 opacity-50 py-2">
            ...
            <svg className="w-5 h-5 text-primary animate-bounce" viewBox="0 0 24 24" fill="currentColor">
          ...
          <p className="text-base md:text-lg text-foreground/70 max-w-3xl mx-auto leading-relaxed font-light animate-fade-in">
            Together with our families, we joyfully invite you to celebrate our wedding as we unite in love and commitment. Join us for a memorable celebration of life, culture, and happiness that will be etched in our hearts forever.
          </p>

          {/* Countdown Timer */}
          <div className="mt-12 md:mt-16 lg:mt-20 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
            <CountdownTimer />
          </div>
          ...
          <div className="pt-4 animate-bounce-slow">
            ...
            >
              Explore Events
              <svg className="w-5 h-5 ml-2 animate-pulse" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
